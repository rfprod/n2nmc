...
@NgModule({
	...
	providers 	: [ {provide: LocationStrategy, useClass: PathLocationStrategy}, TRANSLATION_PROVIDERS, TranslateService, EventEmitterService, UsersListService, ServerStaticDataService, PublicDataService ],
